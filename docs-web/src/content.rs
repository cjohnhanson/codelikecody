...
pub static PAGES: &[DocPage] = &[
    DocPage {
        slug: "",
        title: "codelikecody",
        raw: include_str!("../../clc/docs/index.md"),
        section: None,
    },
    DocPage {
        slug: "what-is-codelikecody",
        title: "What is codelikecody?",
        raw: include_str!("../../clc/docs/what-is-codelikecody.md"),
        section: None,
    },
    DocPage {
        slug: "getting-started",
        title: "Getting Started",
        raw: include_str!("../../clc/docs/getting-started.md"),
        section: None,
    },
    DocPage {
        slug: "clc/phase-system",
        title: "The Phase System",
        raw: include_str!("../../clc/docs/phase-system.md"),
        section: Some("clc"),
    },
    DocPage {
        slug: "clc/orchestration",
        title: "Multi-Agent Orchestration",
        raw: include_str!("../../clc/docs/orchestration.md"),
        section: Some("clc"),
    },
    DocPage {
        slug: "clc/cli-reference",
        title: "clc CLI Reference",
        raw: include_str!("../../clc/docs/cli-reference.md"),
        section: Some("clc"),
    },
    DocPage {
    ...
    DocPage {
        ...
        title: "Writing Tests",
        raw: include_str!("../../missouri/docs/writing-tests.md"),
        section: Some("missouri"),
    },
    DocPage {
    ...
    DocPage {
        ...
        title: "Workflow",
        raw: include_str!("../../tisket/docs/workflow.md"),
        section: Some("tisket"),
    },
    DocPage {
        slug: "tisket/cli-reference",
        title: "tisket CLI Reference",
        raw: include_str!("../../tisket/docs/cli-reference.md"),
        section: Some("tisket"),
    },
];
